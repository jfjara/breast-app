package com.breastapp.breastappratingservice.infraestructure.rabbitmq.config;
...
public class RabbitMQConfig {
    ...
    public SimpleRabbitListenerContainerFactory rabbitListenerContainerFactory() {
        ...
        factory.setErrorHandler(errorHandlerRabbitMq());
        return factory;
    }
    @Bean
    public ErrorHandler errorHandlerRabbitMq() {
